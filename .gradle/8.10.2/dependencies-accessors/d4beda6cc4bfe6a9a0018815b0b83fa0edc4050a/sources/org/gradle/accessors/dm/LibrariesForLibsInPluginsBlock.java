...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class YoutubeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>youtube.player</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final YoutubeVersionAccessors vaccForYoutubeVersionAccessors = new YoutubeVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.youtube</b>
         */
        public YoutubeVersionAccessors getYoutube() {
            return vaccForYoutubeVersionAccessors;
        }
    ...
    public static class PdfVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>pdf.viewer</b> with value <b>2.8.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class YoutubeVersionAccessors extends VersionFactory  {

        public YoutubeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>youtube.player</b> with value <b>12.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayer() { return getVersion("youtube.player"); }
